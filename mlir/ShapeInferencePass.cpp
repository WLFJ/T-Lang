...
#include "tc/Passes.h"
#include "tc/ShapeInferenceInterface.h"
...
#include "tc/ShapeInferenceOpInterfaces.cpp.inc"
...
struct ShapeInferencePass
    : public mlir::PassWrapper<ShapeInferencePass, OperationPass<tc::FuncOp>> {
...
std::unique_ptr<mlir::Pass> mlir::tc::createShapeInferencePass() {
